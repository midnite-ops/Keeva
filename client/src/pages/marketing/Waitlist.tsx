    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="flex flex-col justify-center px-5 md:px-16 lg:px-20 py-20 lg:py-0">
          <div className="max-w-md">
            ...
            <h1 className="font-serif text-4xl md:text-5xl font-lighter lg:text-[3.4rem] text-foreground leading-[1.1] mb-6 animate-fade-up animate-delay-400">
              Designers create.
              <br />
              Creators <em className="font-normal">style.</em>
              <br />
              You shop.
            </h1>

            <p className="text-sm text-muted-foreground leading-relaxed font-sans mb-10 max-w-sm animate-fade-up animate-delay-600">
              A new kind of fashion platform — designers upload their pieces,
              creators style them into complete looks, and you buy outfits
              curated by the people you trust
            </p>
                ...
                {message ? (
                  ...
                  <>
                    ...
                    <p className="text-sm text-muted-foreground font-sans">
                      Stay tuned for updates and thank you for your interest in
                      Keeva! We can't wait to share our vision with you.
                    </p>
                  </>
                )}
              </div>
      ...
      <footer className="fixed bg-white bottom-0 left-0 right-0 flex items-center justify-between px-6 md:px-12 py-4">
        ...
        <div className="flex gap-6">
          <a
            href="#"
            className="text-[10px] tracking-[0.2em] text-muted-foreground uppercase font-sans hover:text-foreground transition-colors"
          >
            Instagram
          </a>
          <a
